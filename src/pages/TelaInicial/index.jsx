    ...
    return (
        <ContainerPage>
            ...
            <div className="temas">
                ...
                <div className="tema-box">
                    <div className="tema-img">
                        <img src="../../../frontend.png" alt="tema2" />
                    </div>
                    <div className="tema-text">
                ...
                <div className="tema-box">
                    <div className="tema-img">
                        <img src="../../../qualityassurance.png" alt="tema3" />
                    </div>
                    <div className="tema-text">
                ...
                <div className="tema-box">
                    <div className="tema-img">
                        <img src="../../../projectmanagement.png" alt="tema4" />
                    </div>
                    <div className="tema-text">
                ...
                <div className="tema-box">
                    <div className="tema-img">
                        <img src="../../../commonskills.png" alt="tema5" />
                    </div>
                    <div className="tema-text">
